...
<div class="hero">
  ...
  <p class="meta">231 項測試通過 · 植入錯誤抓取率 10,435/10,435(零誤報) · 1,367 篇實際判決佐證 · 不需任何 API 金鑰</p>
</div>
"""
...
<div class="statgrid">
  ...
  <div class="stat"><div class="num">1,367</div><div class="lbl">收錄判決(判賠金額逐字讀自主文)</div></div>
